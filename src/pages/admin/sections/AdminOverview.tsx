...
interface DashboardData {
  ...
  revenue: number;
  recentListings: Array<{ id: string; title: string; city: string; status: string; propertyType: string; images?: string[]; createdAt: string; price?: string | null; views?: number }>;
