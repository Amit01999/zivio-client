                    ...
                    {listing.furnishingStatus && (
                      ...
                      >
                        {listing.furnishingStatus === 'furnished' &&
                          'Fully Furnished'}
                        {listing.furnishingStatus === 'semi_furnished' &&
                          'Semi-Furnished'}
                        {listing.furnishingStatus === 'unfurnished' &&
                          'Unfurnished'}
                      </Badge>
                    )}
                    {listing.negotiable && (
                    ...
                    <Card>
                      ...
                      <CardContent>
                        <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">
                          ...
                          {listing.parkingCount !== null &&
                            listing.parkingCount !== undefined && (
                              <div>
                                <p className="text-sm text-muted-foreground">
                                  Parking Spaces
                                </p>
                    ...
                    <Card>
                      ...
                      <CardContent>
                        <div className="mb-4">
                          ...
                          <p className="text-muted-foreground">
                            {[listing.area, listing.city, listing.district].filter(Boolean).join(', ')}
                          </p>
                        </div>
